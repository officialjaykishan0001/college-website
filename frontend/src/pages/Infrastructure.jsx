                ...
                <div className='border border-black shadow-lg shadow-gray-300 min-h-[50px] min-w-[80vw] max-w-[100vw] lg:max-w-[80vw] p-3' >
                    <div className='flex flex-wrap sm:flex-nowrap'>
                        <h1 className='text-2xl font-bold sm:pl-3 pl-0'>
                            <Blockquote>HOSTEL</Blockquote>
                            <img className='min-w-[220px] sm:min-w-[420px] py-3 rounded-md' src="http://www.sgrpgcollege.in/images/hostel.jpg" alt="college-front-pic" />
                        </h1>
                        <div className='flex gap-3 justify-center items-center p-4 py-8'>
                            <div className='text-justify'>
                                ...
                                <span className='font-semibold italic text-gray-600 pl-2'>
                    ...
                    <div className='flex flex-wrap-reverse sm:flex-nowrap'>
                        ...
                        <h1 className='text-2xl font-bold sm:pl-3 pl-0'>
                            ...
                            <img className='min-w-[220px] sm:min-w-[420px] py-3 rounded-md' src="http://www.sgrpgcollege.in/images/library.jpg" alt="college-front-pic" />
                        </h1>
                    </div>
                    <div className='flex flex-wrap sm:flex-nowrap'>
                        <h1 className='text-2xl font-bold sm:pl-3 pl-0'>
                            <Blockquote>COMPUTER LAB.</Blockquote>
                            <img className='min-w-[220px] sm:min-w-[420px] py-3 rounded-md' src="http://www.sgrpgcollege.in/images/ComputerLab.jpg" alt="college-front-pic" />
                        </h1>
                        <div className='flex gap-3 justify-center items-center p-4 py-8'>
                            <div className='text-justify'>
                                <span>
                                ...
                                <span>
                                    <h1 className='font-semibold italic text-gray-600'>INFRASTRUCTURE</h1>
                                    <span>
                                        <p className='italic text-gray-500'>Computer Labs for Practical Classes</p>
                                        <ul className='list-disc pl-8'>
                                            <li>1 lab with 20 computers for 40 students</li>
                                            <li>2 labs with 30 computers for 30 students </li>
                                            <li>1 lab with 15 computers for 15 students.</li>
                                            <li>PC configurations are as follows</li>
                                            <li>P_IV 3.8 GHZ Intel</li>
                                            <li>DDR II 512 MB RAM</li>
                                            <li>80 GB SATA Hard Disk</li>
                                            <li>52X CD ROM</li>
                                            <li>Each lab has one staff machine attach with projector, cd rom drive, USB Drive & Printer.
                                                Cyber Lab for all the college students and staff</li>
                                        </ul>
                                    </span>
                                    <span>
                                        <p className='italic text-gray-500'>1 lab with 20 computers (including 10 LCD & 10 TFT monitor) used as a cyber lab with the minimum charges. Facilities available:</p>
                                        <ul className='list-disc pl-8'>
                                            <li>Net surfing</li>
                                            <li>Project work</li>
                                            <li>Society work</li>
                                            <li>College magazines, brochures work</li>
                                            <li>Print outs</li>
                                            <li>Scanning</li>
                                            <li>CD/DVD Writing</li>
                                        </ul>
                                    </span>
                                </span>
                            </div>
                    ...
                    <div className='flex flex-wrap sm:flex-nowrap'>
                        <h1 className='text-2xl font-bold sm:pl-3 pl-0 '>
                            <Blockquote >GARDEN</Blockquote>
                            <img className='min-w-[220px] sm:min-w-[420px] py-3 rounded-md' src="http://www.sgrpgcollege.in/images/Garden.jpg" alt="college-front-pic" />
                        </h1>
                    ...
                    <div className='flex flex-wrap sm:flex-nowrap'>
                        <h1 className='text-2xl font-bold sm:pl-3 pl-0 '>
                            ...
                            <img className='min-w-[220px] sm:min-w-[420px] py-3 rounded-md' src="http://www.sgrpgcollege.in/images/UnionBank.jpg" alt="college-front-pic" />
                        </h1>
                        <div className='flex justify-center items-center p-4 py-9'>
                            <div className='text-justify'>
