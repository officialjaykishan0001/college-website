...
const AboutSection = () => {
    return (
        <div>
            <div className="relative min-h-[880px] sm:min-h-[520px] lg:min-h-[450px]  w-full">
                ...
                <div className="absolute w-full items-center  text-white py-4">
                    ...
                    <div className='flex justify-around lg:gap-[100px] lg:justify-center items-center py-4 flex-wrap'>
